var styleSwitcher = {
    ...
    build: function() {
        var a = this,
            b = $("<div />").attr("id", "styleSwitcher").addClass("style-switcher hidden-xs").append($("<h4 />").html("Style Switcher").append($("<a />").attr("href", "#").append($("<i />").addClass("fa fa-cogs"))), $("<div />").addClass("style-switcher-mode").append($("<div />").addClass("options-links mode").append($("<a />").attr("href", "#").attr("data-mode", "basic").addClass("active").html("Basic"), $("<a />").attr("href", "#").attr("data-mode", "advanced").html("Advanced"))), $("<div />").addClass("style-switcher-wrap").append($("<h5 />").html("Colors"), $("<ul />").addClass("options colors").attr("data-type", "colors"), $("<h5 />").html("Website Type"), $("<div />").addClass("options-links website-type").append($("<a />").attr("href", "index.html").attr("data-website-type", "normal").html("Normal"), $("<a />").attr("href", "one_page.html").attr("data-website-type", "one-page").html("One Page")), $("<h5 />").html("Background Color"), $("<div />").addClass("options-links background-color").append($("<a />").attr("href", "index.html").attr("data-background-color", "light").html("Light"), $("<a />").attr("href", "home_dark.html").attr("data-background-color", "dark").html("Dark")), $("<hr />"), $("<div />").addClass("options-links").append($("<a />").addClass("reset").attr("href", "#").html("Reset"), $("<a />").addClass("get-css").attr("href", "#getCSSModal").html("Get Skin CSS"))));
        $("body").append(b);
